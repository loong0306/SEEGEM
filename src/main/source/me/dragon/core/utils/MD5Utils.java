...
public class MD5Utils {
    ...
    public static final String PWD1 = "zjs#901";
    public static final String PWD2 = "87x@cka";
    public static final String PWD3 = "1u$k61cc";
    ...
    public static String decodeByAES(String str) {
        ...
        try {
            ...
            byte[] dbs = decrypt(desB, PWD1);
            res = new String(dbs);
        } catch (Exception e) {
            logger.error("AES解密失败,请查看后台日志！");
            return "解密失败";
        }
        return res;
    }
    ...
    public static String encodeByAES(String str) {
        String res = null;
        try {
            byte[] zs = encrypt(str, PWD1);
            res = parseByte2HexStr(zs);
        } catch (Exception e) {
            logger.error("AES加密失败,请查看后台日志！");
            return "加密失败";
        }
        return res;
    }
