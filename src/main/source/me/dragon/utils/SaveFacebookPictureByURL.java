 ...
 */
public class SaveFacebookPictureByURL {
    public static OSSUploadUtil ossUploadUtil = new OSSUploadUtil();
    public static String ROOT = File.separator + "instagram_gem_pics".toUpperCase() + File.separator;// 服务器文件根路径
    ...
    public static String saveToFile(String destUrl) {
        ...
        try {
            ...
            picPath = ossUploadUtil.uploadFile(ips, fileName, "facebook");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
